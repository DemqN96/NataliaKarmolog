...
const faqs = [
  {
    ...
    a: "Кожен урок займає 20-40 хвилин. Нові уроки відкриваються щодня, тому ви рухаєтесь у власному темпі без поспіху.",
  },
  {
  ...
  {
    q: "На скільки днів розрахований курс?",
    a: "Курс включає декілька блоків з уроками. Кожен урок відкривається у визначений день після початку навчання.",
  },
  {
