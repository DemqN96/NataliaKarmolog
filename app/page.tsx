        ...
        <div className="max-w-7xl mx-auto px-6 py-24 w-full grid md:grid-cols-[2fr_3fr] gap-12 items-center">
          ...
          <FadeIn delay={0.25} direction="left" className="order-1 md:order-2 flex justify-center">
            <div className="relative">
              ...
              />
              {/* Badge */}
              <CountUpBadge target={800} suffix="+" label="Задоволених клієнтів" />
            </div>
          </FadeIn>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-14 items-center">
            ...
            <FadeIn direction="left" delay={0.15}>
              ...
              <div className="space-y-4 mb-8">
                {[
                  "Понад 5 років практики роботи з клієнтами",
                  "Більше 800+ людей пройшли особисту трансформацію під моїм керівництвом",
                  "Авторська методика поєднання наукової психології та духовності",
